...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .setDescription("\n\n**Linkler**\n> ・**Botun davet linki: [Tıkla](https://discord.com/oauth2/authorize?client_id=1212354943760211988&permissions=8&scope=bot%20applications.commands)**\n> ・**Botun destek sunucusu: [Tıkla](https://discord.gg/chQKbM6ucx)**\n> ・**Botun gizlilik politikası: [Tıkla](https://github.com/araschain/GalacticRP-Bot-Privacy-Policy)**")
    .setColor('Blue')
